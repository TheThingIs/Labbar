...
public class CarView extends JFrame {
	...
	controller.CarController carC;

	public DrawPanel drawPanel = new DrawPanel(X, Y / 2);
	public SpeedDisplay sp = new SpeedDisplay(X, Y / 2);
	...
	// Constructor
	public CarView(String framename, controller.CarController cc) {
		this.carC = cc;
